const spotlights = [
  {
    ...
    vibe: 'slow living',
    summary:
      'Маршруты вдоль Москвы-реки, рестораны у набережной и школы в шаговой доступности. Показываем реальные уровни шума и света в течение суток.',
  ...
  },
  {
    ...
    vibe: 'creative scene',
    summary:
      'Лофты с кирпичными сводами, галереи во дворах и гастрономия вечернего формата. Публикуем расписание событий прямо в подборке.',
  ...
  },
  {
    ...
    vibe: 'family mix',
    summary:
      'Современные кварталы с велодорожками, детскими павильонами и сервисами для питомцев. Подходит для семейного контракта на 2+ года.',
