const assurances = [
  { title: 'Проверенные хосты', detail: 'верифицируем документы и историю объявлений' },
  { title: 'Единый календарь', detail: 'синхронизирован с показами и бронями' },
  { title: 'Прозрачные условия', detail: 'договора и платежи без скрытых комиссий' },
]
